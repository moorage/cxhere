...
- Prefer small well-scoped files over large monolithic ones.
- Name files and paths to reflect their purpose and content to help discoverability.
...
- Maintain or improve test coverage; target 100% line coverage.
...
- Clones must go to a local/dev instance; prefer snapshot/restore workflows.
- Migrations must be reversible or include a documented rollback plan.
